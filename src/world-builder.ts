...
import type { ProviderImageGenerationService } from "@phantasy/agent/plugin-runtime";
import type { MediaStorageService } from "@phantasy/agent/plugin-runtime";
...
export async function buildScene(
  ...
  if (plannedFlow) {
    ...
    if (p) {
      ...
      // Attach sprite stub info in metadata for future use
      try {
